...
func init() {
	android.RegisterModuleType("llvm13_defaults", llvmDefaultsFactory)
	android.RegisterModuleType("force_build_llvm13_components_defaults", forceBuildLlvmComponentsDefaultsFactory)
}
