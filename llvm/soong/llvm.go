...
func init() {
	android.RegisterModuleType("llvm21_defaults", llvmDefaultsFactory)
	android.RegisterModuleType("force_build_llvm21_components_defaults", forceBuildLlvmComponentsDefaultsFactory)
}
