...
func init() {
	android.RegisterModuleType("llvm23_defaults", llvmDefaultsFactory)
	android.RegisterModuleType("force_build_llvm23_components_defaults", forceBuildLlvmComponentsDefaultsFactory)
}
