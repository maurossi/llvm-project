...
func init() {
	android.RegisterModuleType("llvm20_defaults", llvmDefaultsFactory)
	android.RegisterModuleType("force_build_llvm20_components_defaults", forceBuildLlvmComponentsDefaultsFactory)
}
