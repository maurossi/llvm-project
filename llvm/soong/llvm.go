...
func init() {
	android.RegisterModuleType("llvm18_defaults", llvmDefaultsFactory)
	android.RegisterModuleType("force_build_llvm18_components_defaults", forceBuildLlvmComponentsDefaultsFactory)
}
