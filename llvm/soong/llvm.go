...
func init() {
	android.RegisterModuleType("llvm16_defaults", llvmDefaultsFactory)
	android.RegisterModuleType("force_build_llvm16_components_defaults", forceBuildLlvmComponentsDefaultsFactory)
}
