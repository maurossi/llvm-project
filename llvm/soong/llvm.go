...
func init() {
	android.RegisterModuleType("llvm17_defaults", llvmDefaultsFactory)
	android.RegisterModuleType("force_build_llvm17_components_defaults", forceBuildLlvmComponentsDefaultsFactory)
}
