...
func init() {
	android.RegisterModuleType("llvm19_defaults", llvmDefaultsFactory)
	android.RegisterModuleType("force_build_llvm19_components_defaults", forceBuildLlvmComponentsDefaultsFactory)
}
