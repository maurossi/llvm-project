...
func init() {
	android.RegisterModuleType("llvm11_defaults", llvmDefaultsFactory)
	android.RegisterModuleType("force_build_llvm11_components_defaults", forceBuildLlvmComponentsDefaultsFactory)
}
