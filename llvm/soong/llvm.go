...
func init() {
	android.RegisterModuleType("llvm14_defaults", llvmDefaultsFactory)
	android.RegisterModuleType("force_build_llvm14_components_defaults", forceBuildLlvmComponentsDefaultsFactory)
}
