...
func init() {
	android.RegisterModuleType("llvm15_defaults", llvmDefaultsFactory)
	android.RegisterModuleType("force_build_llvm15_components_defaults", forceBuildLlvmComponentsDefaultsFactory)
}
