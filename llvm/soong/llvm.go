...
func init() {
	android.RegisterModuleType("llvm22_defaults", llvmDefaultsFactory)
	android.RegisterModuleType("force_build_llvm22_components_defaults", forceBuildLlvmComponentsDefaultsFactory)
}
